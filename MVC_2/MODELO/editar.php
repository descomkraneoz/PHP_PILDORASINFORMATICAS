...
<h1>ACTUALIZAR</h1>
    ...
    $base=conectar::conexion();
        ...
        if(!isset($_POST["bot_actualizar"])){
            ...
            //esto corresponde a los datos que traigo del otro formulario mediante la url de la pagina, y no deben mostrarse al recargar la pg
            $Id=$_GET["Id"];
            $nom=$_GET["nom"];
            $ape=$_GET["ape"];
            $dir=$_GET["dir"];
            ...
            //mirar bien el nombre de los campos en el formulario de envio a la hora de asignarlos
            $Id=$_POST["id"];
            $nom=$_POST["nom"];
            $ape=$_POST["ape"];
            $dir=$_POST["dir"];
